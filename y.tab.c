...
static const char *const yytname[] =
{
  ...
  "T_Layout", "T_Continue", "T_Do", "T_Semicolon", "T_Identifier",
  "T_IntConstant", "T_FloatConstant", "T_BoolConstant", "$accept",
  "Program", "DeclList", "Decl", "VarDecl", "VarType", "FnDecl", 0
};
#endif
